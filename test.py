...
for face_location in group_face_locations:
  ...
  if result[0] == True:
    ...
    top, right, bottom, left = group_face_locations[counter]
    print "The rectangle is ", top, right, bottom, left
  counter+=1
  
import cv2
result = cv2.rectangle(group_photo, (left, top), (right, bottom), (0,0,255), 2)
